...
// LOGO & FX
var mylogo1image=new image(basepath + 'cascade-cool-production.png');
var mylogo2image=new image(basepath + 'cascade-vector-demo-logo.png');
var mylogo1canvas;
var mylogo2canvas;
var mylogo1fx;
var mylogo2fx;
...
var myscroll1font = new image(basepath + 'cascade-rising-font1.png');
myscroll1font.initTile(16,16,32);
var myscroll2font = new image(basepath + 'amiga-scrollfont.png');
myscroll2font.initTile(8,16,32);
var myscroll3font = new image(basepath + 'amiga-scrollfont-gold.png');
...
function changeMusic() {
    ...
    modplayer.LoadAndRun(basepath+CascadeModList[CascadeModListPointer].file);
...
function init_before_go() {
    ...
    modplayer.LoadAndRun(basepath+CascadeModList[0].file);
    // LOGO
